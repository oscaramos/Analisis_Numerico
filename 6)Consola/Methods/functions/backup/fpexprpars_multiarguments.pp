 ...
 **********************************************************************}
{
    Exactamente igual que fpexprargs excepto en:
    TFPExpressionParser.Primitive
    src: http://forum.lazarus.freepascal.org/index.php/topic,19627.0.html
    bigeno dice:
...
{$mode objfpc}
{$h+}
unit fpexprpars_multiarguments;
