...
//Tarea: testear si la expresion es valida por medio de una expresion regular
//Atencion: no reconoce los parametros correctamente si dentro de ellos hay un separator en medio de ellos.
