...
uses
  Classes, SysUtils, FileUtil, TAFuncSeries, Forms, Controls,
...
begin
 ...
 intg_trapecio.a := StrToFloat(AreaA.text);
 intg_trapecio.b := StrToFloat(AreaB.text);
 intg_trapecio.n := StrToInt(ediN.text);


 Area.Active:= true;
 ShowMessage(FloatToStr(intg_trapecio.evaluate()));
