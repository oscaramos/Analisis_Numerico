...
procedure TfrmMethodsOC.btnGraphClick(Sender: TObject);
begin
  chartGraphicsFuncSeries1.Pen.Color:= clBlue;
  chartGraphicsFuncSeries1.Active:= True;
end;

procedure TfrmMethodsOC.btnGraph2Click(Sender: TObject);
begin
...
procedure TfrmMethodsOC.btnPointClick(Sender: TObject);
var x, y: Real;
begin
...
procedure TfrmMethodsOC.btn_calculateClick(Sender: TObject);
var
  x: Real;
begin
  FormResults.show;
...
procedure TfrmMethodsOC.chartGraphicsFuncSeries1Calculate(const AX: Double; out AY: Double);
begin
  AY:= ( Fx(AX) );
end;

procedure TfrmMethodsOC.chartGraphicsFuncSeries2Calculate(const AX: Double; out AY: Double);
begin
  AY:= ( dFx(AX) );
end;

procedure TfrmMethodsOC.chartGraphicsFuncSeries3Calculate(const AX: Double; out
  AY: Double);
begin
  AY:= ( Gx(AX) );
end;

procedure TfrmMethodsOC.chkProportionalChange(Sender: TObject);
begin
  chartGraphics.Proportional:= not chartGraphics.Proportional;
end;


procedure TfrmMethodsOC.FormCreate(Sender: TObject);
begin
...
procedure TfrmMethodsOC.trbMaxChange(Sender: TObject);
begin
  chartGraphics.Extent.XMax:= trbMax.Position;
end;

procedure TfrmMethodsOC.trbMinChange(Sender: TObject);
begin
